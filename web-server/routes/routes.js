import conn from './middleware/db'
import config from '../config'
import sms_util from './middleware/sms_util'
...
const AppRouter = (app) =>{
     ...
     * 获取首页轮播图
     */
    app.get('/api/homecasual/', (req, res) => {
     ...
     * 模糊搜索(商品名称)
     */
    app.post('/api/searchgoods', (req, res) => {
        // 获取参数
     ...
     *  1, 3
     */
    app.get('/api/recommendshoplist', (req, res) => {
        // 获取参数
     ...
     * 获取首页商品列表
     */
    app.get('/api/homeshoplist', (req, res) => {
        // 获取总分类
        let cateSqlStr = 'SELECT COUNT(*) FROM category';
        conn.query(cateSqlStr, (error, results) => {
            if (!error) {
                let sqlStr = '';
     ...
     * 获取商品详细信息
     */
    app.get('/api/goodsdetail', (req, res) => {
        // 获取参数
     ...
     * 获取商品评价
     */
    app.get('/api/goodscomment', (req, res) => {
        // 获取参数
     ...
     * 添加商品到购物车
     */
    app.post('/api/add_shop_cart', (req, res) => {
        // 验证用户
        let user_id = req.body.user_id;
        if (!user_id) {
        ...
        */
        ...
        conn.query(sql_str, (error, results) => {
            if (error) {
                ...
                if (results[0]) { // 商品已经存在
                    ...
                    conn.query(add_sql, sql_params, (error) => {
                        if (error) {
     ...
     * 查询购物车的商品
     */
    app.get('/api/cart_goods', (req, res) => {
        // 获取参数
     ...
     * 删除购物车单条商品
     */
    app.post('/api/delete_goods', (req, res) => {
        // 获取数据
     ...
     * 修改用户信息
     */
    app.post('/api/change_user_msg', (req, res) => {
        // 获取客户端传过来的商品信息
     ...
     * 修改用户密码
     */
    app.post('/api/change_user_pwd', (req, res) => {
        // 获取数据
        let id = req.body.id;
        let oriPwd = '';
    ...
    /**
     修改手机
     */
    app.post('/api/change_user_phone', (req, res) => {
        // 获取数据
     ...
     * 管理员退出登录
     */
    app.get('/api/admin_logout', (req, res) => {
     ...
     * 修改商品数量
     */
    app.post('/api/change_goods_count', (req, res) => {
        // 获取数据
        const goods_id = req.body.goods_id;
        ...
        conn.query(sqlStr, strParams, (error) => {
            if (error) {
                console.log(error);
     ...
     * 获取所有用户信息
     */
    app.get('/api/admin_allusers', (req, res) => {
     ...
     * 删除recommend单条商品
     */
    app.post('/api/delete_recom_goods', (req, res) => {
        // 获取数据
        const goods_id = req.body.goods_id;
     ...
     * 修改recommend商品信息
     */
    app.post('/api/update_recom_goods', (req, res) => {
        // 获取数据
        const goods_id = req.body.goods_id;
     ...
     * 添加商品到recommend
     */
    app.post('/api/add_shop_recom', (req, res) => {
        // 获取客户端传过来的商品信息
        const form = new formidable.IncomingForm();
     ...
     * 删除所有商品
     */
    app.post('/api/delete_all_goods', (req, res) => {
        // 获取数据
        const user_id = req.body.user_id;
